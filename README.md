...
10. Using the dplyr library, it calculates the mean of each column grouping them by "subject" (first) and "activity" (second) and stores it in a dataset called "mean_df".
